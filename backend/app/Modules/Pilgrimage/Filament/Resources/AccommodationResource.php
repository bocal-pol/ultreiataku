...
class AccommodationResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Schemas\Components\Section::make('Contact & localisation')->schema([
            ...
            Schemas\Components\Section::make('Tarifs & capacité')->schema([
            ...
            Schemas\Components\Section::make('Équipements')->schema([
            ...
            Schemas\Components\Section::make('Réservation')->schema([
            ...
            Schemas\Components\Section::make('Bivouac')->schema([
            ...
            Schemas\Components\Section::make('Vérification — RG-08')->schema([
